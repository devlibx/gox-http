...
func (s *RestyProviderTestSuite) TestRestyProvider() {
	...
	req := command.NewGoxRequestBuilder("getJsonPlaceholderPosts").WithPathParam("id", "1").Build()
	resp, err := s.goxHttpCtx.Execute(context.Background(), "getJsonPlaceholderPosts", req)
